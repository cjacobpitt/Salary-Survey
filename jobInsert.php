			...
			<div id="content">
				<?php
					if($_GET['link'] == "fields"){
						...
						<a href=\"jobinsert.php\" class=\"close\">close</a>
					  </div>";
					}
					else
					{
				...
				<div class="box">
					...
					<form action="jobinsertgo.php" method="post">
						...
						<div class="form">
								...
								<p>
									...
									<input type="text" name = "comp" class="field size1" />
								</p>
								<p>
									<span class="req">max 100 symbols</span>
									<label>Bonus <span>(If none, enter "0")</span></label>
									<input type="text" name = "bonus" class="field size1" />
								</p>
								<p>
									<span class="req">max 100 symbols</span>
									<label>Health Insurance <span>(If none, enter "0")</span></label>
									<input type="text" name = "health" class="field size1" />
								</p>
								<p class="inline-field">
									<label>Auto Provided?</label>
									<select name = "auto" class="field size2">
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
									<label>Active?</label>
									<select name = "active" class="field size2">
