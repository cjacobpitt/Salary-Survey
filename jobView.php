	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="jobview.php" class="active"><span>Job View</span></a></li>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<?php
								...
								while($row = mysqli_fetch_array($result)) {
								  ...
								  echo "<form action=\"printview.php\">";
								  echo "<input type=\"submit\" class=\"button\" value=\"Print\" style=\"float: right\" /></form>";
								  echo "</div>";
								mysqli_close($con);
							?> 
						</table>
